...
// Format sunrise and sunset times as desired (e.g., HH:MM:SS)
const formattedSunriseTime = sunriseTime.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit', second: '2-digit' });
const formattedSunsetTime = sunsetTime.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit', second: '2-digit' });

// Update HTML elements with sunrise and sunset times
document.getElementById('sunrise').textContent = `Sunrise: ${formattedSunriseTime}`;
document.getElementById('sunset').textContent = `Sunset: ${formattedSunsetTime}`;
